...
//        setExtendedState(MAXIMIZED_BOTH);
    ...
    public NguoiDangFrom(NguoiDung account) {
        initComponents();
    //Load data
...
//        setSizeFormSanPham(ListDK.size());
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblBirthdayDlg, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel9, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblPhoneNumberDlg, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        btnHome.setText("HOẠT ĐỘNG ĐANG MỞ");
        ...
        btnRegistrationHistory.setText("HOẠT ĐỘNG SẮP MỞ");
        ...
        btnParticipationHistory.setText("HOẠT ĐỘNG ĐÃ TẠO");
        ...
        if(imageChoose.getMessageType()==ImageChoose.MessageType.OK){
            ...
            try {
                 ...
                 try {
                     ...
                     Logger.getLogger(NguoiDangFrom.class.getName()).log(Level.SEVERE, null, ex);
                 }
            } catch (IOException ex) {
                 Logger.getLogger(NguoiDangFrom.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//                new SinhVienForm().setVisible(true);
                new NguoiDangFrom(nguoiDung).setVisible(true);
            }
        });
    }
