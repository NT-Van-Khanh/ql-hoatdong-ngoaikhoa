 ...
 * @author ADMIN
 */
public class ActivityRegisterPanel extends javax.swing.JPanel {
    private Activity hoatDong = new Activity();
    private String idAccount;
    /**
     * Creates new form ActivityRegisterPanel
     */
    public ActivityRegisterPanel() {
        initComponents();
    }
    public ActivityRegisterPanel(Activity hoatDong,String idAccount) {
        initComponents();
    ...
    private void registerActivity(){
        ...
        try {
            ...
            if(studentRegister.checkRegisterDB(idAccount,hoatDong.getId())){
                if(studentRegister.updateRegisterDB(idAccount,hoatDong.getId())){
                    kq = true;
                }
            }else{
                if(studentRegister.insertRegisterDB(idAccount,hoatDong.getId())){
                    kq = true;
                }
            }
            if(kq){
               ...
               // System.out.println("Dk thanh cong");
                ...
                JOptionPane.showMessageDialog(this, "Lỗi! Không thể đăng ký");
    ...
    private void initComponents() {
        ...
        lblTitleOfDlg.setForeground(new java.awt.Color(0, 118, 178));
        ...
        jButton2.setBackground(new java.awt.Color(0, 162, 216));
        ...
        jPanel1.setMaximumSize(new java.awt.Dimension(590, 240));
        jPanel1.setMinimumSize(new java.awt.Dimension(590, 240));
        jPanel1.setPreferredSize(new java.awt.Dimension(590, 240));
        ...
        lblPostingTime.setForeground(new java.awt.Color(102, 102, 102));
        ...
        jLabel2.setText("1000/1000 ");

        jLabel1.setForeground(new java.awt.Color(102, 102, 102));
        jLabel1.setText("Số lượng còn lại:");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(lblGenre, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        btnRegister.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentResized(java.awt.event.ComponentEvent evt) {
                btnRegisterComponentResized(evt);
            }
        });
    ...
    private void btnRegisterComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_btnRegisterComponentResized
        // TODO add your handling code here:
    }//GEN-LAST:event_btnRegisterComponentResized
